# Generated by Powerlevel10k configuration wizard on 2023-05-06 at 11:21 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='❮^_^❯❯❯'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='❮x_x❯❯❯'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$POWERLEVEL9K_BACKGROUND

  local ERROR_IDENTIFIER='✘'
  local ERROR_FOREGROUND=9
  local ERROR_BACKGROUND=$POWERLEVEL9K_BACKGROUND

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION=$ERROR_IDENTIFIER
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=$ERROR_FOREGROUND
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=$ERROR_BACKGROUND

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION=$ERROR_IDENTIFIER
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION=$ERROR_IDENTIFIER
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION=$ERROR_IDENTIFIER
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=$POWERLEVEL9K_BACKGROUND
